...
class RDSExport implements FromCollection, WithHeadings
{
    ...
    public function collection()
    {
        $d = Carbon::now();
        $date = $d->format('Y');
        return BeneficiaryRoster::join('assistance_records', 'assistance_records.serial_no', '=', 'beneficiary_roster.serial_no')
